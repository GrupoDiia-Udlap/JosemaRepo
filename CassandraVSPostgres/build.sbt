...
libraryDependencies += "com.datastax.cassandra" % "cassandra-driver-mapping" % "3.1.4"

// https://mvnrepository.com/artifact/org.postgresql/postgresql
libraryDependencies += "org.postgresql" % "postgresql" % "42.1.4"

// https://mvnrepository.com/artifact/com.typesafe.slick/slick_2.11
libraryDependencies += "com.typesafe.slick" % "slick_2.11" % "3.2.0"

// https://mvnrepository.com/artifact/com.typesafe.slick/slick-hikaricp_2.11
libraryDependencies += "com.typesafe.slick" % "slick-hikaricp_2.11" % "3.2.0"
